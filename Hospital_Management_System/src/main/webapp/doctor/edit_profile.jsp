				...
				<div class="card paint-card">
					...
					<div class="card-body">
						<form action="../doctChangePassword" method="post">
							...
							<button class="btn btn-primary primary-background col-md-12">Change
								Password</button>
						</form>
					</div>
				</div>
				...
				<div class="card paint-card">
					...
					<div class="card-body">
						<form action="../doctorUpdateProfile" method="post">
							...
							<button type="submit" class="btn btn-primary primary-background col-md-12">Update</button>
						</form>
